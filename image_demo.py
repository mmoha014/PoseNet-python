...
def main():
    ...
    with tf.Session() as sess:
        ...
        cap = cv2.VideoCapture('/home/mgharasu/Documents/Noah_project/GT_creator/Wo1.MOV')
        ...
        while True:
            ...
            # posenet.read_imgfile(f, scale_factor=args.scale_factor, output_stride=output_stride)
